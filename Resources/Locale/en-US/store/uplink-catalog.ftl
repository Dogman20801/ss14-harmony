...
uplink-pistol-halys-desc = A compact handgun that is often used as a last resort due to it's cheap manufacturing and poor performance. Uses pistol magazines (.25 caseless).
